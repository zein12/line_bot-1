...
class Webhook extends CI_Controller {
 ...
 private function followCallback($event)
 {
...

  {
    ...
    $messagex = "Salam kenal, " . $profile['displayName'] . "!\n";
    $textMessageBuilder = new textMessageBuilder($messagex);
    $message .= "Silakan kirim pesan \"MULAI\" untuk memulai kuis. LOLOLOL";
